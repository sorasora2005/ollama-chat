...
export default function DeleteConfirmModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-[#2d2d2d] rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl border border-gray-300 dark:border-gray-600 animate-in fade-in zoom-in duration-200">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            {description ? (
              ...
              <>
                「<span className="font-medium text-black dark:text-white">{title}</span>」を削除しますか？<br />
                この操作は取り消せません。
              </>
            )}
          </p>
          <div className="flex gap-3 w-full">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-red-600/90 to-red-700/90 hover:from-red-600 hover:to-red-700 text-white rounded-lg transition-all font-medium flex items-center justify-center gap-2 shadow-lg shadow-red-500/20"
            >
