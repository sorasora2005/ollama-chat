  ...
  const loadModels = async () => {
    ...
    try {
      ...
      const cloudModels: Model[] = [
        ...
        { name: 'claude-opus-4-5-20251101', family: 'claude', type: 'vision', downloaded: false, description: 'Anthropic Claude Opus 4.5 (Nov 2025)' },
        { name: 'claude-sonnet-4-5-20250929', family: 'claude', type: 'vision', downloaded: false, description: 'Anthropic Claude Sonnet 4.5' },
        { name: 'claude-haiku-4-5-20251001', family: 'claude', type: 'vision', downloaded: false, description: 'Anthropic Claude Haiku 4.5 (Oct 2025)' },
        { name: 'claude-opus-4-1-20250805', family: 'claude', type: 'vision', downloaded: false, description: 'Anthropic Claude Opus 4.1 (Aug 2025)' },
        { name: 'claude-3-haiku-20240307', family: 'claude', type: 'vision', downloaded: false, description: 'Anthropic Claude 3 Haiku' },
        ...
        { name: 'grok-4-1-fast-non-reasoning', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 4.1 Fast Non-Reasoning' },
        ...
        { name: 'grok-4-fast-non-reasoning', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 4 Fast Non-Reasoning' },
        { name: 'grok-4-0709', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 4 (v0709)' },
        { name: 'grok-3-mini', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 3 Mini' },
        { name: 'grok-3', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 3' },
        { name: 'grok-2-1212', family: 'grok', type: 'text', downloaded: false, description: 'xAI Grok 2' },
        { name: 'grok-2-vision-1212', family: 'grok', type: 'vision', downloaded: false, description: 'xAI Grok 2 Vision' },
